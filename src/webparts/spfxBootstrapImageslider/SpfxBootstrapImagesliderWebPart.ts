...
import * as strings from "SpfxBootstrapImagesliderWebPartStrings";
import SpfxBootstrapImageslider from "./components/SpfxBootstrapImageslider";
import { ISpfxBootstrapImagesliderProps } from "./components/ISpfxBootstrapImagesliderProps";

export interface ISpfxBootstrapImagesliderWebPartProps {
  description: string;
  context: WebPartContext;
  pictureLibraryDropDown: string;
}

export default class SpfxBootstrapImagesliderWebPart extends BaseClientSideWebPart<ISpfxBootstrapImagesliderWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISpfxBootstrapImagesliderProps> =
      React.createElement(SpfxBootstrapImageslider, {
